...
import type { RoutedOwnerAttention } from "@/lib/portfolio-iq/owner-attention-routing";
...
export function buildOwnerBriefingEmail(input: { snapshot: OwnerBriefingSnapshot; recipientName: string | null; reportUrl: string; preview?: boolean; recentActivity?: RoutedOwnerAttention[] }) {
