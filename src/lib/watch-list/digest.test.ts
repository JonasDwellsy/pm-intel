...
function input(overrides: Partial<DigestInput> = {}): DigestInput {
  return {
    ...
    unsubscribeUrl: "https://operators.iq.dwellsy.com/api/digest/unsubscribe?u=user_1&t=abc",
    scorecardBaseUrl: "https://operators.iq.dwellsy.com",
    lists: [
      {
        ...
        operators: [
          {
            ...
            scorecardUrl: "https://operators.iq.dwellsy.com/property-managers/tn/chattanooga/acme-chattanooga-tn",
            changes: [
