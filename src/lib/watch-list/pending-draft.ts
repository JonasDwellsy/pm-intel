...
//
// When an anonymous user clicks Save on /watch-lists/new (template
...
//     real saved watch lists weeks later.
//
// Safety rails:
//
...
export const PENDING_DRAFT_KEY = "dwellsy:pendingWatchListDraft";
