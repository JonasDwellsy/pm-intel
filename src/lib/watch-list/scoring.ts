// v0.8 — Watch list fit scoring.
//
// evaluateWatchList(pm, watchList) → { passed, fitScore, breakdown }.
//
// Algorithm per the watch-list spec:
//
...
// at save time so the persisted watch list never carries blank rows;
