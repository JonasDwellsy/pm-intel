...
export const CLEVELAND_ZIP_CENTERS: Record<string, { latitude: number; longitude: number }> = {
  ...
  "44115": { latitude: 41.4930, longitude: -81.6718 },
  "44118": { latitude: 41.5106, longitude: -81.5663 },
  "44120": { latitude: 41.4779, longitude: -81.5897 },
  "44121": { latitude: 41.5267, longitude: -81.5322 },
  "44123": { latitude: 41.6035, longitude: -81.5254 },
  "44125": { latitude: 41.4255, longitude: -81.6153 },
  "44128": { latitude: 41.4418, longitude: -81.5545 },
  "44130": { latitude: 41.3774, longitude: -81.7875 },
  "44137": { latitude: 41.4130, longitude: -81.5655 },
};

const CLEVELAND_ZIP_TREND_POINTS: Record<string, MarketIqTrendPoint[]> = {
  "44105:house:3": [{ rent: 1372, yearOverYearPct: 0.75, observations: 19, month: "2026-07-01", valueBasis: "trends_value" }],
  "44106:apartment:1": [{ rent: 1113, yearOverYearPct: -23.12, observations: 21, month: "2026-07-01", valueBasis: "trends_value" }],
  "44107:apartment:1": [{ rent: 1050, yearOverYearPct: 12, observations: 13, month: "2026-07-01", valueBasis: "trends_value" }],
  "44109:apartment:1": [{ rent: 900, yearOverYearPct: 28.57, observations: 20, month: "2026-07-01", valueBasis: "trends_value" }],
  "44110:house:3": [{ rent: 1277, yearOverYearPct: -4.13, observations: 10, month: "2026-07-01", valueBasis: "trends_value" }],
  "44112:apartment:1": [{ rent: 750, yearOverYearPct: -19.96, observations: 10, month: "2026-07-01", valueBasis: "trends_value" }],
  "44113:apartment:1": [{ rent: 1199, yearOverYearPct: -7.77, observations: 17, month: "2026-07-01", valueBasis: "trends_value" }],
  "44114:apartment:1": [{ rent: 1341, yearOverYearPct: -8.03, observations: 34, month: "2026-07-01", valueBasis: "trends_value" }],
  "44115:apartment:1": [{ rent: 1462, yearOverYearPct: -1.22, observations: 10, month: "2026-07-01", valueBasis: "trends_value" }],
  "44120:apartment:1": [{ rent: 999, yearOverYearPct: 14.17, observations: 15, month: "2026-07-01", valueBasis: "trends_value" }],
  "44121:house:3": [{ rent: 1728, yearOverYearPct: 3.23, observations: 11, month: "2026-07-01", valueBasis: "trends_value" }],
  "44125:house:3": [{ rent: 1588, yearOverYearPct: 0.36, observations: 14, month: "2026-07-01", valueBasis: "trends_value" }],
  "44128:house:3": [{ rent: 1369, yearOverYearPct: 4.16, observations: 15, month: "2026-07-01", valueBasis: "trends_value" }],
  "44130:apartment:1": [{ rent: 875, yearOverYearPct: -0.72, observations: 17, month: "2026-07-01", valueBasis: "trends_value" }],
  "44137:apartment:1": [{ rent: 680, yearOverYearPct: -2.51, observations: 11, month: "2026-07-01", valueBasis: "trends_value" }],
  "44137:house:3": [{ rent: 1669, yearOverYearPct: 12.22, observations: 10, month: "2026-07-01", valueBasis: "trends_value" }],
