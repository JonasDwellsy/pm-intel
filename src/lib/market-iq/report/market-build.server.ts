  ...
  return buildMarketIqReportSnapshot({
    ...
    sources: [
      ...
      ...(marketActivity ? [{
        ...
        note: "Used for exact 24-hour flow counts and observed daily new-listing, advertised-concession, asking-rent-change, delisting, and live-age threshold activity only. Concessions are advertised, not verified. Standing inventory remains withheld.",
      }] : []),
