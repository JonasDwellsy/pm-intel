...
export const metadata: Metadata = {
  ...
  description:
    "Outside-in scorecards on every property manager in the country. Methodology v0.8 + design v1.0 — 10 markets live across 694 eligible operators. Lease velocity, tenancy, rent performance, marketing, community visibility, and lending signals. Built for institutional diligence.",
  openGraph: {
    title: "Dwellsy IQ — Property Manager Intelligence",
    description:
      "Outside-in scorecards on property managers. v0.8 + v1.0 across 10 covered markets. Built for institutional diligence.",
    type: "website",
  },
};
