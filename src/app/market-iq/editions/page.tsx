  ...
  return <main className="mx-auto w-full max-w-7xl px-5 py-8 sm:px-6 lg:px-10 lg:py-10">
    ...
    <section className="mt-8 grid gap-7 xl:grid-cols-[1fr_380px]">
      ...
      <aside className="space-y-6">
        ...
        <section className="rounded-2xl border border-teal-200 bg-teal-50 p-6"><p className="text-[10px] font-bold uppercase tracking-[0.14em] text-teal-800">After publication</p><p className="mt-2 text-lg font-semibold text-navy">Choose the audience</p><p className="mt-2 text-sm leading-6 text-slate-600">Delivery shows this market&apos;s published report, delivery drafts, and delivery history in one place.</p><Link href={`/market-iq/sharing?market=${encodeURIComponent(activeMarket.id)}`} className="mt-4 inline-block text-sm font-semibold text-teal-800">Open delivery →</Link></section>
      </aside>
    </section>
  </main>;
}
