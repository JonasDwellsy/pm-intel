...
export default async function MarketIqDataOperationsPage() {
  ...
  return <main className="mx-auto w-full max-w-7xl px-5 py-8 sm:px-6 lg:px-10 lg:py-10">
    <nav className="flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-500"><Link href="/market-iq/internal/admin">Market IQ admin</Link><span>/</span><Link href="/market-iq/internal/readiness">Operations readiness</Link><span>/</span><span>Data loading</span></nav>
