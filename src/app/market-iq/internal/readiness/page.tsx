...
export default async function MarketIqInternalReadinessPage() {
  ...
  return <main className="mx-auto w-full max-w-7xl px-5 py-8 sm:px-6 lg:px-10 lg:py-10">
    <nav className="text-xs font-semibold text-slate-500"><Link href="/market-iq/launch">First edition</Link><span className="mx-2">/</span><span>Internal diagnostics</span></nav>
