...
export default async function MarketIqGetStartedPage({ searchParams }: { searchParams: Promise<{ saved?: string; step?: string; flow?: string; market?: string }> }) {
