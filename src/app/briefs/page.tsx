...
export const metadata: Metadata = {
  title: "Market briefs",
  description:
    "Monthly analyst-style market briefs across Dwellsy IQ Markets' covered markets — share movement, operator landscape, and notable signals.",
};
    ...
    <div className="bg-background">
      <div className="mx-auto max-w-[1080px] px-6 py-14 sm:py-20">
        ...
        <p className="mt-4 max-w-[56ch] text-[16px] leading-[1.55] text-foreground/80">
          Analyst-style structural reads across Dwellsy IQ Markets&apos;{" "}
