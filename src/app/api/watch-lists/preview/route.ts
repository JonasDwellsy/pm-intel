// POST /api/watch-lists/preview — run the apply engine against an
// in-memory draft watch list without persisting anything.
//
...
//
// No id is required — we synthesize a draft id since applyWatchList
// expects a WatchListDefinition.id field for its result envelope, and
...
export async function POST(req: Request) {
  ...
  const draft: WatchListDefinition = {
    id: "draft",
    name: "draft",
