...
// v0.12 — watch-list results Excel export button.
//
// Lives in the page header next to Edit Watch List + Re-Run. Click
...
// /watch-lists/[id]/results bundle. Loading on click moves that
// cost off the critical path — the user pays for it only when
// they actually want a workbook.

import * as React from "react";
import { capture } from "@/lib/analytics";
import type { ResultRowVM } from "@/lib/watch-list/results-view";
import type { ExportWatchList } from "@/lib/watch-list/export";
...
export function DownloadButton({
  ...
  async function handleClick() {
    setLoading(true);
    setError(null);
    capture("watch_list_export_click", {
