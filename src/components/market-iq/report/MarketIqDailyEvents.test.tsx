...
const available: MarketIqMarketActivityAvailability = {
  ...
  activity: {
    ...
    events: [
      ...
      { id: "concession:5", eventType: "concession", city: "Cleveland", zip: "44113", propertyType: "apartment", bedrooms: 2, askingRent: 1_500, previousRent: null, observedAt: "2026-08-21T10:30:00.000Z", concession: { kind: "free_rent", label: "Free-rent offer", evidence: "Apply today and receive one month free. Terms apply" } },
    ],
  },
};
