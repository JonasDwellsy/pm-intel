    ...
    <section aria-labelledby="digest-heading" className="mt-10 rounded-lg border border-teal/25 bg-teal-soft p-5 sm:p-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="max-w-2xl">
          <p className="dq-eyebrow">Weekly email</p>
          <h2 id="digest-heading" className="dq-h2">Send yourself a test</h2>
          <p className="mt-2 text-sm leading-6 text-muted-foreground">
            The test goes only to the email address on your account. It does not contact clients.
          </p>
        </div>
        <button
          type="button"
